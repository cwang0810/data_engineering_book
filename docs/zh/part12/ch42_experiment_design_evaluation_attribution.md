...
![图42-1：数据实验设计与策略回写闭环](../../images/part12/chn_01_experiment_feedback_loop.png)
*图42-1 实验的终点不是报分，而是把结论写回数据管线。*
...
![图42-2：平均分与切片评测的差异示意](../../images/part12/chn_02_slice_vs_average.png)
*图42-2 平均分可能稳步上升，但关键切片完全可能同时退化。*
...
![图42-3：归因到策略回写的五条路径](../../images/part12/chn_03_attribution_to_policy_rewrite.png)
*图42-3 真正有价值的归因必须落到采集、清洗、标注、配比或评测的某一步。*
...
![图42-4：六个数据集统一归因雷达图](../../images/part12/chn_04_unified_attribution_radar.png)
*图42-4 建议雷达维度包括结构正确性、逻辑一致性、证据完整性、行为稳定性、风格控制与鲁棒性。*

### 42.5.2 一张统一归因面板至少要回答什么
