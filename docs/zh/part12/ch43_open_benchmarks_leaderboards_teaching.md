...
![图43-1：从数据集到开放基准的生命周期](../../images/part12/cho_01_benchmark_lifecycle.png)
...
![图43-2：六类数据集的开放基准包装地图](../../images/part12/cho_02_benchmark_packaging_map.png)
...
![图43-4：Leaderboard 维护流程图](../../images/part12/cho_04_leaderboard_workflow.png)
...
![图43-3：教学实验路线图](../../images/part12/cho_03_teaching_experiments_roadmap.png)
...
![图43-5：Benchmark Card 模板页示意](../../images/part12/cho_05_benchmark_card_mockup.png)
*图43-5 可视化展示任务定义、指标、提交格式、防污染规则与维护人。*

![图43-6：教学实验路线图](../../images/part12/cho_06_teaching_lab_roadmap.png)
