...
![图40-1：清洗、去重、去污染与隐私治理的四向张力](../../images/part12/chl_01_four_way_tension.png)
*图40-1 数据处理不是单向优化，而是在质量、泛化、评测可信度与合规之间持续权衡。*

## 40.1 清洗不是“统一变干净”，而是“按任务保留价值”
...
![图40-2：重复样本处理三分法](../../images/part12/chl_02_dedup_actions.png)
*图40-2 去重不是简单的二元删除，合并与降权同样重要。*
...
![图40-4：去污染工作流](../../images/part12/chl_04_decontamination_workflow.png)
*图40-4 去污染最好发生在切分之前，而不是排行榜上线之后再救火。*
...
![图40-3：隐私字段分级与处理动作矩阵](../../images/part12/chl_03_privacy_action_matrix.png)
*图40-3 隐私治理不是统一打码，而是字段分级、动作分层与场景隔离。*
