...
*全书架构图。来源：本书自绘。该图以数据全生命周期为主线，将十四篇、四十八章、十五个项目和八个附录组织为基础、采集处理、横切能力、模型对齐、应用治理、安全合规、专项实践和项目交付等层级；Alt text：《大模型数据工程》全书架构图，展示数据全生命周期、主体篇章分层、DataOps 飞轮、平台支撑能力和贯穿全书的工程原则。*
