...
![图2-1：现代数据栈架构](../images/第2章/图2-1_现代数据栈架构.png)
...
![图2-2：数据湖仓架构](../images/第2章/图2-2_数据湖仓架构.png)
...
![图2-3：存储层选型决策树](../images/第2章/图2-3_存储层选型决策树.png)
...
![图2-4：计算框架选型决策树](../images/第2章/图2-4_计算框架选型决策树.png)
...
![图2-5：I/O优化效果对比](../images/第2章/图2-5_IO优化效果对比.png)
...
![图2-6：DVC vs LakeFS架构对比](../images/第2章/图2-6_DVC与LakeFS架构对比.png)
...
![图2-7：基础设施选型速查表](../images/第2章/图2-7_基础设施选型速查表.png)
